...
let flpan = document.querySelector('#apple tbody');
for( let i = 0; i < prova.products.length;i++){
    let koha = prova.products[i];
    let row = flpan.insertRow();

    row.insertCell(0).innerHTML = koha.title;
    row.insertCell(1).innerHTML = koha.description;
    row.insertCell(2).innerHTML = koha.price;
